...
<u>Note</u>: the value of `newClOrdId` is generated by the exchange. It's the ID of `FILLED` order and this order has the reference to the originally placed order via `origClOrdId`.
